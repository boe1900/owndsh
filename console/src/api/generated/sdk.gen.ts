...
export const registerPluginVersion = <ThrowOnError extends boolean = false>(options: Options<RegisterPluginVersionData, ThrowOnError>): RequestResult<RegisterPluginVersionResponses, RegisterPluginVersionErrors, ThrowOnError> => (options.client ?? client).post<RegisterPluginVersionResponses, RegisterPluginVersionErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'enterprise-admin',
            type: 'apiKey'
