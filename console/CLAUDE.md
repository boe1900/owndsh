...
package.json: 独立产品控制台依赖与命令真源，固定 Node 24、pnpm 11、React 19、Vite 8、TanStack Router/Query/Table/Form、Zod、Hey API 及 Beautiful UI 所需 Tailwind/Inter/shadow-plugin；@base-ui/react 1.8.0 提供 shadcn 同源 Combobox 的可访问多选行为，@noble/hashes 2.4.0 提供 HTTP 兼容的 PKCE SHA-256，免费图标统一使用 Lucide。
