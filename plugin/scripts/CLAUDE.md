...
desktop-confirm.test.mjs: 消费显式 OWNDSH_TEST_RUNTIME 的插件页面验收，覆盖只读账号地址、退出后修改/失败保留/授权锁定，以及原型三段卡片/按钮配色、四色气泡/键盘聚焦、更新微闪/减少动态效果、等高双列/两行截断、精简详情/全文展示/技术字段隐藏、分类市场、固定版本安装与更新确认、不可安装原因、重启提示及官方确认框，记录市场与详情的明暗主题和窄屏截图。
