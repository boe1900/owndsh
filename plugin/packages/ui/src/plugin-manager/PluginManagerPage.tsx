/**
 * [INPUT]: 依赖 官方 primitives、slots 与 plugin manager face
 * [OUTPUT]: 对外提供 PluginManagerPage
 * [POS]: 官方插件管理页，只把头部按钮接到 OwnDsh 插件市场
...
import {
  ...
  IconPluginPinwheelOutlineRegular, IconRefreshOutlineRegular, IconTrashOutlineRegular,
...
import { rowConfigKey, type OfficialItem } from './config-ledger.js'
import type { PluginManagerLocaleKey } from './locales.js'
import {
...
import { managementText, noticeText, packageText, registryText, rowText, type Translate } from './presentation.js'
import type { PluginPackageRef, PluginRowRef, PluginsSubject } from './slot-contract.js'
import type { ConfigPageForm } from './slot-contract.js'
        ...
        ? (
          <header className={css.pageHead}>
            ...
            <div className={css.toolbar}>
              ...
              <Button variant="primary" size="sm" className={css.addButton} icon={<IconPluginPinwheelOutlineRegular size={13} />} disabled={!loaded} onClick={props.openMarket}>
                {t('pluginMarket')}
              </Button>
            </div>
          </header>
