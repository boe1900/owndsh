...
package.json: `dsh.bundle`/`dsh.client` 双清单，声明 Harness 官方 caret-compatible credentials/LLM/settings/subprocess/inventory peers 与官方 Client 图，不装载 Session 运行依赖。
