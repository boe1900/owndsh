...
tests/contracts.spec.ts: 遍历 OpenAPI 声明的正反 fixture，验证 Zod、稳定错误码映射、P2-03 bootstrap、P2-06 成员身份、gateway facade、必填安装配置/旧制品字段拒绝、封闭 audit metadata、未知字段拒绝、秘密字段拒绝和品牌隔离。
