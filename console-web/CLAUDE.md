...
package.json: 独立产品控制台依赖与命令真源，固定 Node 24、pnpm 11、React 19、Vite 8、TanStack Router/Query、Hey API 及 Beautiful UI 所需 Tailwind/Inter/shadow-plugin，免费图标统一使用 Lucide。
...
vite.config.ts: Vite、TanStack 文件路由、React、Tailwind、Vitest 与 62209 本地开发端口配置。
...
public/: 仅供组件示例使用的上游静态资源；局部地图见 public/CLAUDE.md。
