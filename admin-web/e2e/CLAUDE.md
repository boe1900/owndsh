...
candidate-release.spec.ts: T22 正式 release 上以真实 OIDC、三设备 rc.7 Harness、双版本插件和只读数据库探针自动化第 21.1 节 14 步；Session 按官方基础设施事件之后的 seed 前缀一致性验收，并采集候选媒体与提供 1 分钟至 24 小时可配置的有界人工暂停。
