...
/** Get one identity source without its secret. GET /enterprise/admin/v1/identity-sources/${param0} */
export async function getIdentitySource(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getIdentitySourceParams,
  ...
  return request<{
    ...
    requestId: string;
  }>(`/enterprise/admin/v1/identity-sources/${param0}`, {
    method: "GET",
    params: { ...queryParams },
    ...(options || {}),
  });
