...
src/generated/: 从唯一 OpenAPI 真源生成的通用、T04 身份、T05 auth/device、T08 model/bootstrap、T09 quota/usage、T10/T11 gateway 及 T13 plugin DTO、Fetch client、strict Zod 与协议元数据，禁止手工编辑。
