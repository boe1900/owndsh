...
src/generated/: 从唯一 OpenAPI 真源生成的通用、T04 身份、T05 两阶段 auth/device、T08 model/bootstrap、T09 quota/usage、T10/T11 gateway 及 T13 plugin DTO、Fetch client、strict Zod 与协议元数据，禁止手工编辑。
...
tests/contracts.spec.ts: 遍历 OpenAPI 声明的 43 个正反 fixture，验证 Zod、36 个错误码映射、T09/T10/T11/T13 facade、T19 空 metadata、未知字段拒绝、秘密字段拒绝和品牌隔离。
