...
src/generated/: 从唯一 OpenAPI 真源生成的通用、T04 身份及 T05 auth/device DTO、Fetch client、strict Zod 与协议元数据，禁止手工编辑。
...
tests/contracts.spec.ts: 遍历 OpenAPI 声明的全部正反 fixture，验证 Zod、36 个错误码映射、未知枚举拒绝和品牌隔离。
