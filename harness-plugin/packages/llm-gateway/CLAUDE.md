...
src/adapter.ts: 官方 LlmAdapter 实现，从 bootstrap 解析动态目录/default，以 SSE/JSON 双媒体协商经平台 Service 直连中心模型流。
...
tests/adapter.spec.ts: 动态目录/default、SSE/JSON 请求协商、header/body、reasoning/tool/usage、错误矩阵与取消回归。
