...
src/proxy.ts: 自有随机端口与 bearer 的 Host 私有 loopback 代理，透明 relay 原生 JSON/SSE，替换平台 Authorization，不经浏览器 WebServer carrier。
...
tests/proxy.spec.ts: 验证未授权本机请求被拒绝、透明 relay、平台 SSE/JSON 双媒体声明和伪认证隔离。
