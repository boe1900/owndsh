/**
 * [INPUT]: 依赖 Cordis/Schemastery、官方 LlmRuntime/subprocess/inventory 与企业平台、模型、插件、Session 模块
 * [OUTPUT]: 对外提供企业 bundle Host apply、完整官方 Service inject 清单与带固定信任根的 Config schema
 * [POS]: bundle 的唯一 Host Loader 入口，组合平台认证、企业 provider、受管插件调和与验收 seam
...
export const inject = ['webServer', 'sessions', 'llm', 'subprocess', 'pluginInventory']
