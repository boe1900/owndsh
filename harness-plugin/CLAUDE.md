...
package.json: workspace 根清单，固定 Node/pnpm 版本并统一暴露 build/typecheck/test、pack、consumer 与 T11/T14/T15 真实组合门禁。
...
scripts/: tarball consumer 与锁定 Harness T01/T07/T11/T14/T15 真实组合验收入口，只操作临时目录/profile。
