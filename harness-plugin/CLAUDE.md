...
packages/: 正式企业插件模块，包含 T06 平台 Service、自包含 bundle 与 T02 contracts；局部地图见 `packages/CLAUDE.md`。
scripts/: contracts/platform-client tarball consumer 与锁定 Harness 真实组合验收入口，只操作临时目录/profile。
