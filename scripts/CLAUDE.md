...
t22-candidate.sh: T22 动态候选入口，生成三套 TLS 信任边界、构建/安装正式 release、编排隔离 fixture/三设备 Harness/14 步 Playwright、失败销毁前日志取证、默认 10 分钟且可覆盖至 24 小时的有界人工暂停、媒体和敏感扫描并精确清理自身资源。
