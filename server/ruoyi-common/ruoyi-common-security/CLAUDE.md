...
src/main/java/org/dromara/common/security/config/SecurityConfig.java: 全局 Sa-Token Servlet/filter 与路由鉴权入口；非企业路由校验登录/clientid，企业 API 完整下沉到领域 context 读取 Token session 以保留撤销语义。
