/**
 * [INPUT]: 依赖 PlatformSessionGateway、Host user/RBAC、LoginHelper、Sa-Token 与管理端 HttpOnly Cookie 约定。
...
public final class OwnDshPlatformSessionGateway implements PlatformSessionGateway {
    ...
    private static String currentToken() {
        ...
        String cookie = SaHolder.getRequest().getCookieValue(AdminSessionCookie.NAME);
