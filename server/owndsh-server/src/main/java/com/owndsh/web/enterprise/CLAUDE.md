...
OwnDshPlatformSessionGateway.java: 平台会话 composition adapter，签发 12 小时非共享 client/device Sa-Token；保留协议对应管理端 Cookie 的 Controller 内兜底读取，Desktop Bearer、设备撤销和 kickout 语义不变。
