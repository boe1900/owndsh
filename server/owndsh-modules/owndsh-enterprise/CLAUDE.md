...
src/main/resources/db/migration/: PostgreSQL `V0` 至 `V35` 真源，V0 承接原 Host 基线，空库与旧 baseline 0 共用后续迁移，建立企业事实、Refresh Session、实测 usage 快照与独立配额扣额；局部地图见 db/migration/CLAUDE.md。
