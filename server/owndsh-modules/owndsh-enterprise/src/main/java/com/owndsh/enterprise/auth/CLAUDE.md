...
EnterpriseIdentityConfiguration.java: 身份纵向模块 composition root，从部署 URI/master key、Redis/JDBC/事务装配成员目录、三个 adapter、PKCE、PostgreSQL Refresh Session 与 Sa-Token 端口。
