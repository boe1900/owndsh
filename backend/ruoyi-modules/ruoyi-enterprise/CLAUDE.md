...
src/main/java/org/dromara/enterprise/auth/: 身份领域、OIDC/LDAP/LOCAL adapter、身份源管理与外部身份绑定纵向模块；局部地图见 auth/CLAUDE.md。
src/main/java/org/dromara/enterprise/common/: 企业 HTTP envelope、稳定错误映射、requestId 与绑定 tenant/filter 的认证 cursor 公共边界；局部地图见 common/CLAUDE.md。
