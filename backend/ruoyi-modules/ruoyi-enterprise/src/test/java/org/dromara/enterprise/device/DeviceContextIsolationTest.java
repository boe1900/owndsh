/**
 * [INPUT]: 依赖 RuoYiDeviceRequestContextResolver、mock PlatformSessionGateway 与伪造 X-Device-Id request。
...
class DeviceContextIsolationTest {
    ...
    void ignoresForgedDeviceHeadersAndUsesOnlyServerSessionTerminal() {
        ...
        RuoYiDeviceRequestContextResolver resolver = new RuoYiDeviceRequestContextResolver(properties, sessions);
