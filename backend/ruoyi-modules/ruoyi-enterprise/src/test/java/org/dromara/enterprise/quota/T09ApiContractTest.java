...
import org.dromara.enterprise.quota.web.AdminQuotaController;
import org.dromara.enterprise.quota.web.AdminUsageController;
import org.dromara.enterprise.quota.web.RuntimeUsageController;
...
class T09ApiContractTest {
    ...
    private static QuotaUsageQueryService.PolicyUsage policyUsage() {
        ...
        return new QuotaUsageQueryService.PolicyUsage(
            policy(), windows.get(0), windows.get(1),
            new QuotaUsageQueryService.RateUsage(15, 3, DAY_RESET),
            new QuotaUsageQueryService.ConcurrencyUsage(3, 1)
        );
    }
