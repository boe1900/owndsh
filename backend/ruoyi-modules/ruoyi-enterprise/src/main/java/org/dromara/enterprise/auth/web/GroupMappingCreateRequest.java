/**
 * [INPUT]: 接收身份源 ID、外部组精确值与 RuoYi 部门 ID。
 ...
 * 外部组映射创建请求。
 */
public record GroupMappingCreateRequest(String sourceId, String externalGroup, String departmentId) {
    public long parsedSourceId() {
        return positive(sourceId, "sourceId");
    }

    public long parsedDepartmentId() {
        return positive(departmentId, "departmentId");
    }
