/**
 * [INPUT]: 依赖 DeviceService ACTIVE 校验、BootstrapUserStore、EffectiveModelResolver 与全局 revision store。
 * [OUTPUT]: 对外提供当前 dsh-desktop 设备的用户、设备、revision 和有效模型快照。
 * [POS]: model/application 的 T08 bootstrap 组合服务，未来切片不在此提前实现。
...
public final class BootstrapService {
    ...
    public BootstrapSnapshot load(DeviceCallContext context) {
        ...
        return new BootstrapSnapshot(revisions.current(context.tenantId()), user, device, models);
    }
