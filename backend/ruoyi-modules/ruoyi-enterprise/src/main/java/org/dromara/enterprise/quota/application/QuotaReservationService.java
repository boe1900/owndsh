...
public final class QuotaReservationService {
    ...
    private void addPending(
        ...
        QuotaWindowCalculator.WindowBounds bounds = windowCalculator.bounds(now, type);
        ...
        if (occupied > limit - command.estimatedTokens()) {
            QuotaExceededException.Kind kind = type == QuotaWindowType.DAY
                ? QuotaExceededException.Kind.DAILY
                : QuotaExceededException.Kind.MONTHLY;
