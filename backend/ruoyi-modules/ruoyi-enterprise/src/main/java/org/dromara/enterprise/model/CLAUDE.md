...
application/: 密钥生命周期、CAS/审计事务、全员/成员授权与排序默认解析及 bootstrap 模型切片；局部地图见 application/CLAUDE.md。
persistence/: 模型表和 RuoYi 成员事实的 JDBC adapters；局部地图见 persistence/CLAUDE.md。
