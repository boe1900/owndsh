...
pom.xml: 应用装配 Maven 清单，只聚合企业运行所需的 RuoYi system/API、认证辅助与 ruoyi-enterprise，排除 Generator、Demo、Workflow、RuoYi AI、Job、MCP、MySQL 和未启用监控客户端，并提供 Spring Boot 与 Draft 2020-12 JSON Schema 测试运行时。
