...
java/org/dromara/test/EnterpriseContractSchemaTest.java: 遍历 OpenAPI 生成的 16 项 manifest，以 Draft 2020-12 schema 验证与 TypeScript 相同的通用/身份/auth/device 正反 fixture。
